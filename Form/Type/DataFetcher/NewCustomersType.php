...
use Sylius\Bundle\ReportBundle\DataFetcher\NumberOfNewCustomersDataFetcher;
 ...
 */
class NewCustomersType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('period', ChoiceType::class, [
                'choices' => NumberOfNewCustomersDataFetcher::getPeriodChoices(),
                'multiple' => false,
